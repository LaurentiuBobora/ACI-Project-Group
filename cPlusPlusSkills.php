...
<html>
	...
	<body>
		...
		<table name="tabelSkills">
			<th colspan="2"> 
				Select skills and level for C++ technology
			</th>
			
			<tr>
				<td align="center" class="textId"> Skill 1 </td>
			...
			<tr>
				<td align="center" class="textId"> Skill 2 </td>
				<td align="center" class="textId">
				<div class="styled-select">
			...
			<tr>
				<td align="center" class="textId"> Skill 3 </td>
				<td align="center" class="textId">
				<div class="styled-select">
					<select id="skill3">
						<option id="lv0" value="0">Level 0</option>
			...
			tr>
				<td align="center" class="textId"> Skill 4 </td>
				<td align="center" class="textId">
				<div class="styled-select">
					<select id="skill4">
						<option id="lv0" value="0">Level 0</option>
			...
			tr>
				<td align="center" class="textId"> Skill 5 </td>
				<td align="center" class="textId">
				<div class="styled-select">
					<select id="skill5">
						<option id="lv0" value="0">Level 0</option>
